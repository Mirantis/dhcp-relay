...
func ValidateLayers(
	...
	if layerIPv4.SrcIP == nil || layerIPv4.SrcIP.To4() == nil {
		return errors.New("source IP is not valid IPv4")
	}

	if layerIPv4.SrcIP.IsMulticast() || layerIPv4.SrcIP.IsLinkLocalMulticast() {
		return errors.New("source IP is Multicast IPv4")
	}

	if layerIPv4.DstIP == nil || layerIPv4.DstIP.To4() == nil {
		return errors.New("destination IP is not valid IPv4")
	}

	if layerIPv4.DstIP.IsMulticast() || layerIPv4.DstIP.IsLinkLocalMulticast() {
		return errors.New("destination IP is Multicast IPv4")
	}

	if layerUDP == nil {
		return errors.New("invalid UDP layer data")
	}
	...
	if layerDHCPv4 == nil {
		return errors.New("invalid DHCPv4 layer data")
	}
